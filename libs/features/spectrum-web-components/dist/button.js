...
import{html as h,SizedMixin as C}from"/libs/features/spectrum-web-components/dist/base.js";import{property as b}from"/libs/features/spectrum-web-components/dist/base.js";import{html as l}from"/libs/features/spectrum-web-components/dist/base.js";import{property as p,query as w}from"/libs/features/spectrum-web-components/dist/base.js";import{LikeAnchor as x}from"/libs/features/spectrum-web-components/dist/shared.js";import{Focusable as z}from"/libs/features/spectrum-web-components/dist/shared.js";import{ObserveSlotText as A}from"/libs/features/spectrum-web-components/dist/shared.js";import{css as g}from"/libs/features/spectrum-web-components/dist/base.js";var y=g`
...
`,v=E;import{when as P}from"/libs/features/spectrum-web-components/dist/base.js";var q=Object.defineProperty,B=Object.getOwnPropertyDescriptor,i=(s,t,o,c)=>{for(var r=c>1?void 0:c?B(t,o):t,n=s.length-1,u;n>=0;n--)(u=s[n])&&(r=(c?u(t,o,r):u(r))||r);return c&&r&&q(t,o,r),r},S=["accent","primary","secondary","negative","white","black"];var e=class extends C(a,{noDefaultSize:!0}){constructor(){super(...arguments),this.pendingLabel="Pending",this.pending=!1,this.cachedAriaLabel=null,this._variant="accent",this.treatment="fill"}static get styles(){return[...super.styles,v]}click(){this.pending||super.click()}get variant(){return this._variant}set variant(t){if(t!==this.variant){switch(this.requestUpdate("variant",this.variant),t){case"cta":this._variant="accent";break;case"overBackground":this.removeAttribute("variant"),this.static="white",this.treatment="outline";return;case"white":case"black":this.static=t,this.removeAttribute("variant");return;case null:return;default:S.includes(t)?this._variant=t:this._variant="accent";break}this.setAttribute("variant",this.variant)}}set quiet(t){this.treatment=t?"outline":"fill"}get quiet(){return this.treatment==="outline"}firstUpdated(t){super.firstUpdated(t),this.hasAttribute("variant")||this.setAttribute("variant",this.variant)}updated(t){super.updated(t),t.has("pending")&&(this.pending&&this.pendingLabel!==this.getAttribute("aria-label")?this.disabled||(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)):!this.pending&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):!this.pending&&this.cachedAriaLabel===""&&this.removeAttribute("aria-label")),t.has("disabled")&&(!this.disabled&&this.pendingLabel!==this.getAttribute("aria-label")?this.pending&&(this.cachedAriaLabel=this.getAttribute("aria-label")||"",this.setAttribute("aria-label",this.pendingLabel)):this.disabled&&this.cachedAriaLabel?this.setAttribute("aria-label",this.cachedAriaLabel):this.disabled&&this.cachedAriaLabel==""&&this.removeAttribute("aria-label"))}renderButton(){return h`
            ${this.buttonContent}
            ${P(this.pending,()=>(import("/libs/features/spectrum-web-components/dist/progress-circle.js"),h`
                    <sp-progress-circle
                        indeterminate
                        static="white"
                        aria-hidden="true"
                    ></sp-progress-circle>
                `))}
        `}};i([b({type:String,attribute:"pending-label"})],e.prototype,"pendingLabel",2),i([b({type:Boolean,reflect:!0,attribute:!0})],e.prototype,"pending",2),i([b()],e.prototype,"variant",1),i([b({type:String,reflect:!0})],e.prototype,"static",2),i([b({reflect:!0})],e.prototype,"treatment",2),i([b({type:Boolean})],e.prototype,"quiet",1);import{defineElement as F}from"/libs/features/spectrum-web-components/dist/base.js";F("sp-button",e);
