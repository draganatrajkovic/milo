...
import{html as h,nothing as P,SpectrumElement as g}from"/libs/features/spectrum-web-components/dist/base.js";import{property as s,query as b}from"/libs/features/spectrum-web-components/dist/base.js";import{css as n}from"/libs/features/spectrum-web-components/dist/base.js";var u=n`
...
`,a=u;var d=Object.defineProperty,l=Object.getOwnPropertyDescriptor,e=(i,p,m,r)=>{for(var o=r>1?void 0:r?l(p,m):p,c=i.length-1,v;c>=0;c--)(v=i[c])&&(o=(r?v(p,m,o):v(o))||o);return r&&o&&d(p,m,o),o},t=class extends g{constructor(){super(...arguments),this.dialog=!1,this.open=!1,this.tip=!1}static get styles(){return[a]}renderTip(){return h`
        ...
        `}update(p){super.update(p)}render(){return h`
            <slot></slot>
            ${this.tip?this.renderTip():P}
        `}};e([s({type:Boolean,reflect:!0})],t.prototype,"dialog",2),e([s({type:Boolean,reflect:!0})],t.prototype,"open",2),e([s({reflect:!0})],t.prototype,"placement",2),e([s({type:Boolean,reflect:!0})],t.prototype,"tip",2),e([b("#tip")],t.prototype,"tipElement",2);import{defineElement as f}from"/libs/features/spectrum-web-components/dist/base.js";f("sp-popover",t);
