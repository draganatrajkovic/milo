...
import{supportsAdoptingStyleSheets as g}from"/libs/features/spectrum-web-components/dist/base.js";import{version as d}from"/libs/features/spectrum-web-components/dist/base.js";var b=["spectrum","express"],h=["medium","large","medium-express","large-express"],v=["light","lightest","dark","darkest","light-express","lightest-express","dark-express","darkest-express"],m=class o extends HTMLElement{constructor(){super(),this._dir="",this._theme="spectrum",this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});let e=document.importNode(o.template.content,!0);this.shadowRoot.appendChild(e),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","theme","lang","dir"]}set dir(e){if(e===this.dir)return;this.setAttribute("dir",e),this._dir=e;let t=e==="rtl"?e:"ltr";this.trackedChildren.forEach(r=>{r.setAttribute("dir",t)})}get dir(){return this._dir}attributeChangedCallback(e,t,r){t!==r&&(e==="color"?this.color=r:e==="scale"?this.scale=r:e==="lang"&&r?(this.lang=r,this._provideContext()):e==="theme"?this.theme=r:e==="dir"&&(this.dir=r))}requestUpdate(){window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow?window.ShadyCSS.styleElement(this):this.shouldAdoptStyles()}get theme(){let e=o.themeFragmentsByKind.get("theme"),{name:t}=e&&e.get("default")||{};return this._theme||t||""}set theme(e){if(e===this._theme)return;let t=e&&b.includes(e)?e:this.theme;t!==this._theme&&(this._theme=t,this.requestUpdate()),t?this.setAttribute("theme",t):this.removeAttribute("theme")}get color(){let e=o.themeFragmentsByKind.get("color"),{name:t}=e&&e.get("default")||{};return this._color||t||""}set color(e){if(e===this._color)return;let t=e&&v.includes(e)?e:this.color;t!==this._color&&(this._color=t,this.requestUpdate()),t?this.setAttribute("color",t):this.removeAttribute("color")}get scale(){let e=o.themeFragmentsByKind.get("scale"),{name:t}=e&&e.get("default")||{};return this._scale||t||""}set scale(e){if(e===this._scale)return;let t=e&&h.includes(e)?e:this.scale;t!==this._scale&&(this._scale=t,this.requestUpdate()),t?this.setAttribute("scale",t):this.removeAttribute("scale")}get styles(){let e=[...o.themeFragmentsByKind.keys()],t=(r,s,a)=>{let c=a&&a!=="theme"&&this.theme==="express"?r.get(`${s}-express`):r.get(s),i=s==="spectrum"||!a||this.hasAttribute(a);if(c&&i)return c.styles};return[...e.reduce((r,s)=>{let a=o.themeFragmentsByKind.get(s),c;if(s==="app"||s==="core")c=t(a,s);else{let{[s]:i}=this;c=t(a,i,s)}return c&&r.push(c),r},[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise(e=>{this.__resolve=e})}onQueryTheme(e){if(e.defaultPrevented)return;e.preventDefault();let{detail:t}=e;t.color=this.color||void 0,t.scale=this.scale||void 0,t.lang=this.lang||document.documentElement.lang||navigator.language,t.theme=this.theme||void 0}connectedCallback(){if(this.shouldAdoptStyles(),window.ShadyCSS!==void 0&&window.ShadyCSS.styleElement(this),o.instances.add(this),!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!(e instanceof o);)e=e.assignedSlot||e.parentNode||e.host;this.dir=e.dir==="rtl"?e.dir:"ltr"}}disconnectedCallback(){o.instances.delete(this)}startManagingContentDirection(e){this.trackedChildren.add(e)}stopManagingContentDirection(e){this.trackedChildren.delete(e)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){let e=this.styles;if(window.ShadyCSS!==void 0&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){let t=[];for(let[r,s]of o.themeFragmentsByKind)for(let[a,{styles:c}]of s){if(a==="default")continue;let i=c.cssText;o.defaultFragments.has(a)||(i=i.replace(":host",`:host([${r}='${a}'])`)),t.push(i)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(t,this.localName),window.ShadyCSS.prepareTemplate(o.template,this.localName)}else if(g){let t=[];for(let r of e)t.push(r.styleSheet);this.shadowRoot.adoptedStyleSheets=t}else this.shadowRoot.querySelectorAll("style").forEach(t=>t.remove()),e.forEach(t=>{let r=document.createElement("style");r.textContent=t.cssText,this.shadowRoot.appendChild(r)})}static registerThemeFragment(e,t,r){let s=o.themeFragmentsByKind.get(t)||new Map;s.size===0&&(o.themeFragmentsByKind.set(t,s),s.set("default",{name:e,styles:r}),o.defaultFragments.add(e)),s.set(e,{name:e,styles:r}),o.instances.forEach(a=>a.shouldAdoptStyles())}_provideContext(){this._contextConsumers.forEach(([e,t])=>e(this.lang,t))}_handleContextPresence(e){e.stopPropagation();let t=e.composedPath()[0];if(this._contextConsumers.has(t))return;this._contextConsumers.set(t,[e.detail.callback,()=>this._contextConsumers.delete(t)]);let[r,s]=this._contextConsumers.get(t)||[];r&&s&&r(this.lang||document.documentElement.lang||navigator.language,s)}};m.themeFragmentsByKind=new Map,m.defaultFragments=new Set(["spectrum"]),m.instances=new Set,m.VERSION=d;var l=m;customElements.define("sp-theme",l);import{css as f}from"/libs/features/spectrum-web-components/dist/base.js";var y=f`
...
`,n=k;l.registerThemeFragment("spectrum","theme",n);l.registerThemeFragment("light","color",u);import{css as w}from"/libs/features/spectrum-web-components/dist/base.js";var z=w`
...
`,p=z;l.registerThemeFragment("medium","scale",p);export{l as Theme};
